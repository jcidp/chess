...
class Board
  def reset
    self.board = Array.new(8) do |row|
      case row
      when 0 then ["\u2656", Knight.new("white"), "\u2657", "\u2655", "\u2654", "\u2657", Knight.new("white"), "\u2656"]
      when 1 then ["\u2659", "\u2659", "\u2659", "\u2659", "\u2659", "\u2659", "\u2659", "\u2659"]
      when 6 then ["\u265F", "\u265F", "\u265F", "\u265F", "\u265F", "\u265F", "\u265F", "\u265F"]
      when 7 then ["\u265C", Knight.new("black"), "\u265D", "\u265B", "\u265A", "\u265D", Knight.new("black"), "\u265C"]
      else Array.new(8)
      end
    end
  end
  ...
  def move_piece(from, to)
    ...
    return false unless valid_move?(piece, target) && piece.valid_move?(from, to) # See what makes sense to return here
  ...
  def display
    ...
    7.downto(0) do |row|
      puts(8.times.reduce("#{row + 1} |") do |str, col|
        ...
        char = char.is_a?(Knight) ? char.code : char
